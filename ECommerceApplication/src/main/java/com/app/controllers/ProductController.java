...
public class ProductController {
	...
	public ResponseEntity<ProductResponse> getProductsByCoupon(
		...
		ProductResponse productResponse = productService.searchByBrand(brandName, pageNumber, pageSize, sortBy,
				sortOrder);
